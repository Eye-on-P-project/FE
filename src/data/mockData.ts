...
export const initialRiskUsers: RiskUser[] = [
  { name: '김민수', team: '운수팀 A', alertCount: 12, sessionsToday: 12, isOnline: true },
  { name: '마동석', team: '운수팀 C', alertCount: 9, sessionsToday: 8, isOnline: true },
  { name: '지석진', team: '업무팀 2', alertCount: 8, sessionsToday: 11, isOnline: false },
  { name: '김태리', team: '운수팀 B', alertCount: 7, sessionsToday: 10, isOnline: true },
  { name: '이소율', team: '운수팀 C', alertCount: 7, sessionsToday: 13, isOnline: true },
  { name: '이광수', team: '업무팀 2', alertCount: 6, sessionsToday: 15, isOnline: false },
  { name: '송혜교', team: '업무팀 1', alertCount: 5, sessionsToday: 9, isOnline: true },
  { name: '박연우', team: '운수팀 B', alertCount: 4, sessionsToday: 14, isOnline: true },
  { name: '정하준', team: '업무팀 1', alertCount: 4, sessionsToday: 10, isOnline: false },
  { name: '최지우', team: '운수팀 A', alertCount: 4, sessionsToday: 11, isOnline: true },
  { name: '한효주', team: '운수팀 B', alertCount: 3, sessionsToday: 12, isOnline: true },
  { name: '송중기', team: '업무팀 1', alertCount: 2, sessionsToday: 10, isOnline: false },
  { name: '김도현', team: '업무팀 2', alertCount: 2, sessionsToday: 11, isOnline: true },
  { name: '이준호', team: '운수팀 A', alertCount: 2, sessionsToday: 12, isOnline: true },
  { name: '유해진', team: '운수팀 C', alertCount: 1, sessionsToday: 13, isOnline: false },
  { name: '손예진', team: '업무팀 1', alertCount: 1, sessionsToday: 10, isOnline: true },
  { name: '공유', team: '운수팀 B', alertCount: 1, sessionsToday: 11, isOnline: true },
  { name: '정우성', team: '운수팀 B', alertCount: 0, sessionsToday: 12, isOnline: false },
  { name: '조진웅', team: '운수팀 C', alertCount: 0, sessionsToday: 10, isOnline: true },
  { name: '현빈', team: '업무팀 1', alertCount: 0, sessionsToday: 11, isOnline: false },
  { name: '박서준', team: '운수팀 A', alertCount: 0, sessionsToday: 12, isOnline: true },
  { name: '최은재', team: '업무팀 2', alertCount: 0, sessionsToday: 10, isOnline: false },
  { name: '강하늘', team: '운수팀 A', alertCount: 0, sessionsToday: 11, isOnline: true },
  { name: '김희애', team: '운수팀 C', alertCount: 0, sessionsToday: 12, isOnline: true },
  { name: '김종국', team: '업무팀 2', alertCount: 0, sessionsToday: 10, isOnline: false },
]
