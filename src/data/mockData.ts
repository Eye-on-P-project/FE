...
export const initialRiskUsers: RiskUser[] = [
  { name: '김민수', alertCount: 12, sessionsToday: 12, isOnline: true },
  { name: '마동석', alertCount: 9, sessionsToday: 8, isOnline: true },
  { name: '지석진', alertCount: 8, sessionsToday: 11, isOnline: false },
  { name: '김태리', alertCount: 7, sessionsToday: 10, isOnline: true },
  { name: '이소율', alertCount: 7, sessionsToday: 13, isOnline: true },
  { name: '이광수', alertCount: 6, sessionsToday: 15, isOnline: false },
  { name: '송혜교', alertCount: 5, sessionsToday: 9, isOnline: true },
  { name: '박연우', alertCount: 4, sessionsToday: 14, isOnline: true },
  { name: '정하준', alertCount: 4, sessionsToday: 10, isOnline: false },
  { name: '최지우', alertCount: 4, sessionsToday: 11, isOnline: true },
  { name: '한효주', alertCount: 3, sessionsToday: 12, isOnline: true },
  { name: '송중기', alertCount: 2, sessionsToday: 10, isOnline: false },
  { name: '김도현', alertCount: 2, sessionsToday: 11, isOnline: true },
  { name: '이준호', alertCount: 2, sessionsToday: 12, isOnline: true },
  { name: '유해진', alertCount: 1, sessionsToday: 13, isOnline: false },
  { name: '손예진', alertCount: 1, sessionsToday: 10, isOnline: true },
  { name: '공유', alertCount: 1, sessionsToday: 11, isOnline: true },
  { name: '정우성', alertCount: 0, sessionsToday: 12, isOnline: false },
  { name: '조진웅', alertCount: 0, sessionsToday: 10, isOnline: true },
  { name: '현빈', alertCount: 0, sessionsToday: 11, isOnline: false },
  { name: '박서준', alertCount: 0, sessionsToday: 12, isOnline: true },
  { name: '최은재', alertCount: 0, sessionsToday: 10, isOnline: false },
  { name: '강하늘', alertCount: 0, sessionsToday: 11, isOnline: true },
  { name: '김희애', alertCount: 0, sessionsToday: 12, isOnline: true },
  { name: '김종국', alertCount: 0, sessionsToday: 10, isOnline: false },
]
